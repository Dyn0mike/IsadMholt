...
namespace IsadMholt.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdCustomer,Name,CookieId,Expires")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCustomer,Name,CookieId,Expires")] Customer customer)
        {
